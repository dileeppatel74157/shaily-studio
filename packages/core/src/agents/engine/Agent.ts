...
import { AgentMetadata } from "../models/AgentMetadata";
import { AgentState } from "../types/AgentState";
import { AgentContext } from "../models/AgentContext";
import { AgentLifecycle } from "../types/AgentLifecycle";
  ...
  public async execute(input?: unknown): Promise<unknown> {
    ...
    try {
      ...
      if (
        ...
        this.capabilities.includes("production" as any) &&
        this.context.productionEngine &&
        input &&
        typeof input === "object" &&
        "scriptId" in input
      ) {
