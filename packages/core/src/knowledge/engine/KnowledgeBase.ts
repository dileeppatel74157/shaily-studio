import { IKnowledgeBase } from "../interfaces/IKnowledgeBase";
...
import { KnowledgeSearch } from "../models/KnowledgeSearch";
import { KnowledgeValidationException, deepFreeze } from "../types/types";
