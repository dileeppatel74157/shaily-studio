import { IRuntimeEngine, IServiceRegistry, IHealthMonitor, IHeartbeatManager, IStartupManager, IShutdownManager, IScheduler, IRuntimeReporter } from "../interfaces/interfaces";
...
export class RuntimeEngine implements IRuntimeEngine {
  ...
  constructor(
    ...
    const socialPlatformEngine = new SocialPlatformBuilder()
      .withContext(_context)
      .build();
    this.registerEngine({
      id: "SocialPlatformEngine",
      engine: socialPlatformEngine,
      dependencies: [
        "ContentPipelineEngine",
        "YouTubeIntegrationEngine",
        "MediaProviderEngine",
