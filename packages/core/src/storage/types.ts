...
export class InvalidStorageStateException extends StorageException {
  constructor(action: string, currentState: StorageState) {
    super(`Cannot perform "${action}" while Storage is in "${currentState}" state.`);
  }
}
