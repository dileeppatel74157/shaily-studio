...
export class GeminiVoiceBuilder {
  private _id = "gemini-voice";
  private _name = "Google Gemini Voice";
  private _context?: GeminiContext;
  private _configuration?: GeminiVoiceConfiguration;
  ...
  public withConfiguration(configuration: GeminiVoiceConfiguration): this {
  ...
  public build(): GeminiVoiceProvider {
    if (!this._context) {
      throw new Error("Context is required for GeminiVoiceProvider.");
    }
    if (!this._configuration) {
      throw new Error("Configuration is required for GeminiVoiceProvider.");
    }
